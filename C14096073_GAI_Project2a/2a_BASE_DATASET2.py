...
## Load dataset.
data = pd.read_csv(os.path.join('dataset2.csv'))

# Create virtual labels based on the sample counts of each case.
virtual_labels = []
case_lengths = [1000000]
...
for epoch in range(EPOCHS):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model, "best_model_BASE_DATASET2.pth")
...
plt.tight_layout()
plt.savefig("training_validation_curves_BASE_DATASET2.png")
plt.show()
