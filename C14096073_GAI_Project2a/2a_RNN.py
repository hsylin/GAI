...
class CustomModel(torch.nn.Module):
    def __init__(self, embedding_dim, hidden_dim, tokenizer, num_classes):
        ...
        self.lstm = torch.nn.RNN(input_size=embedding_dim, hidden_size=hidden_dim, batch_first=True)
...
for epoch in range(EPOCHS):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(model, "best_model_RNN.pth")
...
plt.tight_layout()
plt.savefig("training_validation_curves_RNN.png")
plt.show()
